...
const FormTambah = () => {
  const [kdkaryawan, setKaryawan] = useState('');
    ...
    if (!token) {
      ...
      fetch(`${apiUrl}karyawan`, {
        ...
        .then(async response => {
          ...
          Alert.alert(
            'Success',
            'Data karyawan Atau Guru berhasil ditambahkan',
            [
              {
                text: 'ok',
                onPress: () =>
                  navigation.navigate('DataKaryawan', {dataAdded: true}),
              },
            ],
          );
        })
  ...
  return (
    <ScrollView
      ...
      <Input
        placeholder="Kode karyawan Atau Guru"
        value={kdkaryawan}
        onChangeText={setKaryawan}
        placeholderTextColor="#888"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        leftIcon={<Icon name="user-circle" size={24} color="black" />}
        errorMessage={validationErrors.kdkaryawan}
      />
