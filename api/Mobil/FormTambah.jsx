...
const FormTambah = () => {
  const [kdmobil, setKdmobil] = useState('');
  ...
  const submitForm = async () => {
    ...
    fetch(`${apiUrl}mobil`, {
      ...
      .then(async response => {
        ...
        Alert.alert('Success', 'Data mobil berhasil ditambahkan', [
          {
            text: 'ok',
            onPress: () => navigation.navigate('DataMobil', {dataAdded: true}),
          },
        ]);
      })
      .catch(error => {
