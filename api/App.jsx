...
import NavPelanggan from './Karyawan/Navigasi';
import NavJabatan from './Jabatan/Navigasi';
      ...
      <Stack.Navigator>
        {userToken == null ? (
          ...
          <>
            ...
            {/* Silahkan Kalian Tambah juga untuk NavJabatan dan Matakuliah dibawahnya */}
          </>
        )}
      </Stack.Navigator>
    </NavigationContainer>
